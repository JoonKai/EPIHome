...
namespace EPI.Wafers
{
    public class WaferFileService
    {
        ...
        public WaferDataModel LoadFromMapFile(string mapFilePath)
        {
            ...
            var cells = MapFileParser.Parse(mapFilePath);  // static 호출
            ...
            return new WaferDataModel
            {
                ...
                {
                    "PeakWavelength", "DominantWavelength", "FWHM",
                    "PeakIntensity", "IntegratedIntensity",
                    "PhotoDetect", "Reflection", "Transmittance",
                    "Thickness", "ZPos", "BlueReflection"
                }
            };
        }
