...
{
    public partial class EPIKoroRobot : UserControl
    {
        public static readonly DependencyProperty Axis1AngleProperty =
        DependencyProperty.Register(nameof(Axis1Angle), typeof(double), typeof(EPIKoroRobot),
            new PropertyMetadata(0.0, OnAxisAngleChanged));

        public static readonly DependencyProperty Axis2AngleProperty =
            DependencyProperty.Register(nameof(Axis2Angle), typeof(double), typeof(EPIKoroRobot),
                new PropertyMetadata(0.0, OnAxisAngleChanged));

        public static readonly DependencyProperty Axis3AngleProperty =
            DependencyProperty.Register(nameof(Axis3Angle), typeof(double), typeof(EPIKoroRobot),
                new PropertyMetadata(0.0, OnAxisAngleChanged));
